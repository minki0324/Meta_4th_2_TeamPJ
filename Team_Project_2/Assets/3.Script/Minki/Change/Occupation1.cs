...
public class Occupation1 : MonoBehaviour
{
    // 점령
    // 1. 점령 후 깃발 색 변경
    // 2. 점령 후 포인트가 속도 변경
    ...
    [SerializeField] private ColorSet1 color;
    ...
    {
        // 나중에 컬러별로 수정
        skinnedmesh.material = Flag_Color[GameManager1.instance.Color_Index];
        color.RecursiveSearchAndSetTexture(player, GameManager1.instance.Color_Index);
